...
DEF QOL = FALSE
DEF BUGFIXES = FALSE
DEF SGB_BORDER = FALSE
DEF SAVE_BUTTON_COMBO = FALSE
DEF NO_LOW_HEALTH_BEEP = FALSE
DEF SLOW_HEALTH_BEEP = FALSE
DEF NO_PHOTO_OVERLAY = FALSE
DEF NO_THIEF_DOWNSIDES = FALSE
...
ELIF !STRCMP("{LANG}", "RX")
DEF LANG_EN = TRUE		; Use English language
DEF REDUX = TRUE		; Use Redux changes
DEF VWF = TRUE			; Use VWF hack
DEF QOL = TRUE			; Use Quality of Life hacks
DEF BUGFIXES = TRUE		; Apply many bugfixes from Rando
DEF SGB_BORDER = TRUE		; Add Super Game Boy Border (DX)
DEF SAVE_BUTTON_COMBO = TRUE	; Change Save button combo (Start+Sel)
DEF NO_LOW_HEALTH_BEEP = FALSE	; Disable low health beep
DEF SLOW_HEALTH_BEEP = TRUE		; Make health beep slower
DEF NO_PHOTO_OVERLAY = TRUE		; Remove photo overlays
DEF NO_THIEF_DOWNSIDES = TRUE	; Remove Thief photo downsides
DEF FILE_28 = $28
DEF FILE_6C = $6C
DEF FILE_2C = $2C
DEF FILE_64 = $64
DEF EASTER_EGG_FILENAME_1 equs "ZELDA"	; Zelda
DEF EASTER_EGG_SONG_1 equ $60 ; MUSIC_ZELDA_NICKNAME_EASTER_EGG
DEF EASTER_EGG_FILENAME_2 equs "TOTA"	; Totaka
DEF EASTER_EGG_SONG_2 equ $3C ; MUSIC_TOTAKEKE_NICKNAME_EASTER_EGG
DEF THIEF_NAME equs "THIEF"
DEF __RECALCULATE_MAX_HEARTS__ = TRUE	; Make player's max health legal
DEF __SPLIT_KEY_CAVERN_MAP__ = FALSE	; Split the Key Cavern map into 1F and B1F 
DEF __SKIP_DIALOG_SUPPORT__ = TRUE	; Previously PATCH_1
DEF __OPTIMIZATIONS_1__ = TRUE
DEF __OPTIMIZATIONS_3__ = TRUE
DEF __PATCH_0__ = TRUE
DEF __PATCH_2__ = TRUE
DEF __PATCH_3__ = TRUE
DEF __PATCH_4__ = TRUE
DEF __PATCH_9__ = TRUE		; Space for Totaka's song in File Menu
;DEF __PATCH_8__ = TRUE
;DEF __PATCH_A__ = 2
;DEF __PATCH_B__ = 2
