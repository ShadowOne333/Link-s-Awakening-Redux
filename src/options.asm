...
BUGFIXES = TRUE			; Apply many bugfixes from Rando
SGB_BORDER = TRUE		; Add Super Game Boy Border (DX)
SAVE_BUTTON_COMBO = TRUE	; Change Save button combo (Start+Sel)
NO_LOW_HEALTH_BEEP = FALSE	; Disable low health beep
SLOW_HEALTH_BEEP = TRUE		; Make health beep slower
...
THIEF_NAME equs "THIEF"
__RECALCULATE_MAX_HEARTS__ = TRUE	; Make player's max health legal
__SPLIT_KEY_CAVERN_MAP__ = FALSE	; Split the Key Cavern map into 1F and B1F 
__SKIP_DIALOG_SUPPORT__ = TRUE	; Previously PATCH_1
__OPTIMIZATIONS_1__ = TRUE
__OPTIMIZATIONS_3__ = TRUE
__PATCH_0__ = TRUE
__PATCH_2__ = TRUE
