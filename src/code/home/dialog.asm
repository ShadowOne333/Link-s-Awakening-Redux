...
IF VWF
    ld   a, [wDialogBoxPosIndexHi]                ;; 00:2334 $FA $69 $D6
    and  a                                        ;; 00:2337 $A7
    ld   a, [wDialogBoxPosIndex]                  ;; 00:2338 $FA $68 $D6
ELSE
...
.jp_250D
    ...
    push hl                                       ;; 00:2515 $E5
IF VWF
    ld   a, [wDialogBoxPosIndex]		  ;; 00:2516 $FA $D8 $D6
ELSE
...
IF VWF
    ld   a, [wDialogBoxPosIndex]                  ;; 00:252E $FA $68 $D6
ELSE
...
ENDC
    ...
    ld   a, [hl]                                  ;; 00:2582 $7E
    ld   [wDialogNextChar], a                     ;; 00:2583 $EA $C3 $C3, upcoming character, used in code for the arrow
...
IF VWF
    ld   a, $00                                   ;; 00:2606 $3E $00, Prints a character with 0 width if it's a space from the player's name
ELSE
    ld   a, " "                                   ;; 00:2606 $3E $20
ENDC
.handleNameChar
...
IF __DIACRITICS_SUPPORT__ ;|| REDUX	; Test
...
DialogBreakHandler::
IF VWF
    ld   a, [wDialogBoxPosIndex]		  ;; 00:2695 $FA $68 $D6
ELSE
